...
<title>Currency Converter with Google API</title>
...
#currencyBox, #results {width:490px;margin:0 auto;margin-bottom:10px;}
...
label {display:block;padding-bottom:2px;font-weight:bold; color:#FFF;}

.data {float:left;width:auto;padding:0 5px;}

input[type=button] {margin-top:15px;cursor:pointer;background:#333333;color:#09C;border:none;padding:2px 5px;-moz-border-radius:5px;border-radius:5px;}

input[type=submit] {margin-top:15px;cursor:pointer;background:#333333;color:#09C;border:none;padding:2px 5px;-moz-border-radius:5px;border-radius:5px;}
...
<div id="currencyBox">
    <div class="data">
        ...
        <input type="text" name="amount" id="amount" value="<?php echo  $cart->calculate_gTotal(); ?>" />
    </div>
    
    <div class="data">
        <label for="fromCurrency">From this currency:</label>
        <select name="fromCurrency" id="fromCurrency">
          <option selected="" value="PKR">Pakistan Rupees - PKR</option>
